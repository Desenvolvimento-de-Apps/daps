    ...
    <CustomSafeArea style={styles.container}>
      <Header
            ...
            <ScrollView style={styles.body}>
                ...
                {adocaoAtivo && <View style={styles.formContainer}>
                    <BasicForm title='Adoção'></BasicForm>

                    <Text style={styles.formText}>EXIGÊNCIAS PARA ADOÇÃO</Text>
                    <CheckboxGroup
                        label=""
                        options={['Termo de adoção', 'Fotos da casa', 'Visita prévia ao animal', 'Acompanhamento pós adoção']}
                ...
                {apadrinharAtivo && <View style={styles.formContainer}>
                ...
                {ajudaAtivo && <View style={styles.formContainer}>
                    {!adocaoAtivo && !apadrinharAtivo && <BasicForm title='Ajudar'></BasicForm>}

                    {(adocaoAtivo || apadrinharAtivo) && <View style={styles.formContainer}>
                    ...
                    <InputText inputType='text' style={styles.input} placeholder="Nome do medicamento" placeholderTextColor="#bdbdbd"/>
                    <InputText inputType='text' style={styles.input} placeholder="Especifique o(s) objeto(s)" placeholderTextColor="#bdbdbd"/>
